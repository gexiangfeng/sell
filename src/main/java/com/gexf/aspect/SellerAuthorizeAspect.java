...
public class SellerAuthorizeAspect {
    ...
    @Pointcut("execution(public * com.gexf.controller.Seller*.*(..))" +
            "&& !execution(public * com.gexf.controller.SellerUserController.*(..))")
    public void verify() {}
    ...
    public void doVerify() {
        ...
        if (StringUtils.isEmpty(tokenValue)) {
            ...
            throw new SellerAuthorizeException();
        	 ...
        	 log.info("【登录校验】Redis中查到token" + tokenValue);
        }
    }
}